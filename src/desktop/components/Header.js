    ...
    return (
        <MainBox>
                <IconBox onClick={()=>{navigate('/');}} id="header-home">
                    ...
                    <Link underline='none' color={'black'} fontWeight={'bold'} marginLeft={'0.8vw'} fontSize={'1rem'}>Fix it now</Link>
                </IconBox>
                <UserBox>
                    ...
                    <NewTicketButton 
                        variant="text"
                        onClick={
                            ()=>{navigate(isLogin==='true'?"/ticket/new":"/login");
                            }
                        }
